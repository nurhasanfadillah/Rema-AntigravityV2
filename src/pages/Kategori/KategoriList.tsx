            ...
            {showAddForm && (
                <Card className="border-purple-500/30 bg-purple-500/5">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <h3 className="font-semibold text-lg border-b border-zinc-800 pb-2 text-purple-100">{editingId ? 'Edit Kategori' : 'Tambah Kategori'}</h3>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-900 border border-zinc-700 focus:border-purple-500 rounded-lg px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
                    ...
                    categories.map(cat => (
                        <Card key={cat.id} className="hover:border-blue-700/50 hover:bg-gradient-to-r hover:from-blue-900/40 hover:to-blue-800/40 transition-colors flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <button onClick={() => handleEdit(cat)} className="p-1.5 text-zinc-400 hover:text-purple-400 rounded-md hover:bg-purple-500/10 transition-colors">
