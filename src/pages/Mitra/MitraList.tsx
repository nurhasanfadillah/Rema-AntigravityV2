...
export function MitraList() {
    const { mitras, fetchMitras, isLoading, addMitra } = useMitraStore();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        await addMitra({
            ...formData,
            limit_tagihan: formData.limit_tagihan ? parseInt(formData.limit_tagihan, 10) : 0
        });
            ...
            {showAddForm && (
                <Card className="border-blue-500/30 bg-blue-500/5">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <h3 className="font-semibold text-lg border-b border-gray-800 pb-2">Tambah Mitra Baru</h3>
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            <Button type="submit" variant="primary" fullWidth disabled={isLoading}>{isLoading ? 'Menyimpan...' : 'Simpan Mitra'}</Button>
                        </div>
                    </form>
                </Card>
            )}
