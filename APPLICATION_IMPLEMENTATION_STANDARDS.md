...
2. Standar UX dan UI
   ...
   2.6 Standar Header & Logo: Gunakan layout header yang compact dengan padding proposional (`px-4 py-2.5`). Logo utama (`LOGO_HEADER_REMVAV2`) harus diletakkan di tengah (*center alignment*) dengan skala visual yang dominan namun tidak menyebabkan header terlalu tinggi (`h-[47px]` atau ±47px untuk mobile).
